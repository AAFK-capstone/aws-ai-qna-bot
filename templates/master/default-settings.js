var default_settings = {
    ...
    ALT_SEARCH_KENDRA_FAQ_SHOW_LINK: true, // show source link of FAQ answer
    ALT_SEARCH_KENDRA_FAQ_SHOW_HELPFUL_LINKS: true, // show Document answers when Kendra returns FAQ answer
    ALT_SEARCH_KENDRA_FAQ_HELPFUL_LINKS_MESSAGE: "", // Message to show when Document links is found
    ALT_SEARCH_KENDRA_FAQ_SHOW_HELPFUL_LINKS_TEXT: true, // show Document excerpts when Kendra returns FAQ answer
    ...
    LOG_CUSTOM_SESSION_ATTRIBUTES: true, // Log custom session attributes in DynamoDB
    LOG_CUSTOM_SESSION_ATTRIBUTES_PREFIX: "Customer", // Custom Session Attributes identifier (Log everything that starts with this) DO NOT PUT 'qnabot', 'connect', 'user'
    AWS_TRANSLATE_MSG: "Answer dynamically translated by Amazon Translate",
    DOCUMENT_BUCKETNAME: "",
};
