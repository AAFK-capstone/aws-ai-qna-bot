...
/**
 * These js function are used for translations
 * @param {*} sourceLang 
 * @returns 
 */
...
exports.translate_hit = async function(hit,usrLang,req){
    ...
    let translateMsg = _.get(req, "_settings.AWS_TRANSLATE_MSG", "");
    let formattedMsg = "";
    ...
    if (a && _.get(hit,'autotranslate.a')) {
        try {
            ...
            hit_out.a = formattedMsg + hit_out.a;
    ...
    if (markdown && _.get(hit,'autotranslate.alt.markdown')) {
        try {
            ...
            hit_out.alt.markdown = formattedMsg + hit_out.alt.markdown;
    ...
    if (rp && _.get(hit,'autotranslate.rp')) {
        try {
            hit_out.rp = translateMsg + " " + hit_out.rp;
