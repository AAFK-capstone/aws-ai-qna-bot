...
/*
* Using AWS Connect to create conversation flow, set SessionAttributes, get Customer inputs, add items to queue or invoke Lambdas. 
* Integrate with Lex chatbot by specifying its Chatbot ARN.
* An example of how Connect is used to create conversation flow is here:
* https://aws.amazon.com/blogs/contact-center/amazon-connect-with-amazon-lex-press-or-say-input/
* https://docs.aws.amazon.com/connect/latest/adminguide/amazon-lex.html
* The contact flow JSON file is used as input to a Lambda function which creates an object consisting of a dictionary CallFlow, callflow filename, qna filename.
*/
